...
class Config:
    ...
    def __init__(self, config_file: str = None):
        ...
        self.embedding_provider = os.getenv("EMBEDDING_PROVIDER", "azure_openai")
        ...
        self.smart_token_limit = int(os.getenv("SMART_TOKEN_LIMIT", 4096))
        ...
        self.llm_kwargs = {"api_version": self.AZURE_OPENAI_API_VERSION}
